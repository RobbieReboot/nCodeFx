<%@ Page Language="C#" MasterPageFile="~/DocSite.Master" AutoEventWireup="true" CodeBehind="DocSiteBrowseIndex.aspx.cs" Inherits="nCodeFxLibDocs.DocSiteBrowseIndex" Title="nCodeFxLibDocs - Browse Index" 
