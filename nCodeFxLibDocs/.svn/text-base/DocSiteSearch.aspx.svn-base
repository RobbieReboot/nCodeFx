<%@ Page Language="C#" MasterPageFile="~/DocSite.Master" AutoEventWireup="true" CodeBehind="DocSiteSearch.aspx.cs" Inherits="nCodeFxLibDocs.DocSiteSearch" Title="nCodeFxLibDocs - Search" 
