<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocSiteHeader.ascx.cs" Inherits="nCodeFxLibDocs.Controls.DocSiteHeader" %>
...
<div id="docsite_header_title"><%= nCodeFxLibDocs.DocSite.ProjectTitle %></div>
<div id="docsite_header_company"><%= nCodeFxLibDocs.DocSite.ProjectCompany %></div>